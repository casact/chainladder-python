...
class TriangleProtocol(Protocol):
    ...
    def sum(self, axis: str | int | None = None, *args, **kwargs) -> Self: ...
    def fillna(self, value: int | float | ndarray | None = None, inplace: bool = False) -> Self: ...
    def fillzero(self, inplace: bool = False) -> Self: ...
