...
from chainladder.legacy.display import TriangleDisplay
from chainladder.legacy.dunders import TriangleDunders
from chainladder.legacy.pandas import TrianglePandas
from chainladder.legacy.slice import TriangleSlicer
